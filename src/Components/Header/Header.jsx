  ...
  return (
    <header className={styles.header}>
      <div className={styles.content}>
        ...
        <p className="dark-bg">
          Se você busca um momento de tranquilidade em meio à agitação do dia a dia, venha conhecer a Bubble Coffe. Nosso espaço foi cuidadosamente projetado para proporcionar uma experiência única, em sintonia com a
          natureza.
        </p>

    ...
    <footer className={styles.footer}>
      <div className={styles.content}>
        <div className={styles.column1}>
          ...
          <h3 className="p">
            Desfrute de um café de qualidade enqaunto se reconecta com o que é
            essencial.
          </h3>
          <SocialLinks />
        </div>
        <div className={styles.column2}>
          ...
          <div className={styles.column3}>
            ...
            <ul>
              <li>Segunda à Sexta - 09h00 às 18h00</li>
              <li>Sábados - 09h00 às 14h00</li>
              <li>(00) 00000-0000</li>
              <li>contato@bytescoffee.com</li>
            </ul>
          </div>
        </div>      
      <span>Bytes Coffee - Todos os direitos reservados.</span>
    </footer>
  );
};
